...
def resnetCIFAR20(**kwargs):
    return ResNet_CIFAR10(BasicBlock,[3,3,3],width_per_group=16, **kwargs), 64 

def resnetCIFAR32(**kwargs):
    return ResNet_CIFAR10(BasicBlock,[5,5,5],width_per_group=16, **kwargs), 64

def resnetCIFAR44(**kwargs):
    return ResNet_CIFAR10(BasicBlock,[7,7,7],width_per_group=16, **kwargs), 64

def resnetCIFAR56(**kwargs):
    return ResNet_CIFAR10(BasicBlock,[9,9,9],width_per_group=16, **kwargs), 64

def resnetCIFAR110(**kwargs):
    return ResNet_CIFAR10(BasicBlock,[18,18,18],width_per_group=16, **kwargs), 64

def resnetCIFAR1202(**kwargs):
    return ResNet_CIFAR10(BasicBlock,[200,200,200],width_per_group=16, **kwargs), 64
